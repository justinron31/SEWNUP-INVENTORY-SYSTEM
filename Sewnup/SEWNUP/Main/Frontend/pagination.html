            ...
            <div class="page-sidebar">
                <ul class="list-unstyled accordion-menu">
                  ...
                  <li class="active-page">
                    <a href="index.html" class="active"><i data-feather="code"></i>Components<i class="fas fa-chevron-right dropdown-icon"></i></a>
                    <ul class="">
                      ...
                      <li><a href="pagination.html" class="active"><i class="far fa-circle"></i>Pagination</a></li>
                    ...
                    <div class="col">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <p class="card-description">Pagination is built with list HTML elements so screen readers can announce the number of available links. Use a wrapping <code>&lt;nav&gt;</code> element to identify it as a navigation section to screen readers and other assistive technologies.</p>
                    ...
                    <div class="col">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <p class="card-description">Looking to use an icon or symbol in place of text for some pagination links? Be sure to provide proper screen reader support with <code>aria</code> attributes.</p>
                          <nav aria-label="Page navigation example">
                            <ul class="pagination">
                              <li class="page-item">
                    ...
                    <div class="col">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <p class="card-description">Pagination links are customizable for different circumstances. Use <code>.disabled</code> for links that appear un-clickable and <code>.active</code> to indicate the current page.</p>
                          <nav aria-label="...">
                            <ul class="pagination">
                    ...
                    <div class="col">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <p class="card-description">Fancy larger or smaller pagination? Add <code>.pagination-lg</code> or <code>.pagination-sm</code> for additional sizes.</p>
                          <nav aria-label="...">
                    ...
                    <div class="col">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <p class="card-description">Change the alignment of pagination components with flexbox utilities.</p>
                          <nav aria-label="Page navigation example">
