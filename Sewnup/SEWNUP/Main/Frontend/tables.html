            ...
            <div class="page-sidebar">
                <ul class="list-unstyled accordion-menu">
                  ...
                  <li class="active-page">
                    <a href="index.html" class="active"><i data-feather="list"></i>Tables<i class="fas fa-chevron-right dropdown-icon"></i></a>
                    <ul class="">
                      <li><a href="tables.html" class="active"><i class="far fa-circle"></i>Basic Tables</a></li>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Add <code>.table-hover</code> to enable a hover state on table rows within a <code>&lt;tbody&gt;</code>.</p>
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">Add <code>.table-bordered</code> for borders on all sides of the table and cells.</p>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">Add <code>.table-borderless</code> for a table without borders.</p>
  ...
  <div class="col">
      <div class="card">
          <div class="card-body">
              ...
              <p class="card-description">Add <code>.table-sm</code> to make any <code>.table</code> more compact by cutting all cell <code>padding</code> in half.</p>
